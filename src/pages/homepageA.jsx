...
const homepageA = () => {
  return (
       ...
       <div className='appointment absolute mt-[164px]  ml-[373px]  w-[1024px] h-[200px]'>
        ...
        <Button className=' absolute bg-primarygreen font-[500] text-[16px] leading-[20px] flex items-center justify-center w-[380px] h-[40px] top-[120px] left-[322px] rounded-[8px] text-white'>
